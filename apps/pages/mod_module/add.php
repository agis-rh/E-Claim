...
<div class="container-fluid padded">
    <div class="form-group">
        <a href="?page=parent" class="btn btn-blue">Tambah Parent Module</a>
    </div><br>
    <div class="box">
                        ...
                        <div class="form-group">
                            ...
                            <div class="span10">
                                <select class="select2-container select2-container-multi chzn-select" name="icon">
                                    ...
                                    <option value="icon-align-right">icon right</option> 
                                    ...
                                    <option value="icon-chevron-right">icon right</option> 
    ...
    if (isset($_POST['save'])) {
        ...
        $query->tambah_module($parent, $nama, $icon, $path, $url, $ordering);
         // Log Aktifitas
        $query->log($_SESSION[id_user],'Menambahkan module baru',$tgl_sekarang,$jam_sekarang);

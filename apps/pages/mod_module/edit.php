...
<div class="container-fluid padded">
    <div class="form-group">
        <a href="?page=tambah_module" class="btn btn-blue">Tambah Parent Module</a>
    </div><br>
    <div class="box">
            ...
            <div class="row-fluid">
                ...
                <div class="span8 separate-sections">
                    <form class="form-horizontal fill-up validatable" action=""  method="POST">
                        ...
                        <div class="form-group">
                            <label class="control-label span2">Parent Module :</label>
                            <div class="span10">
                                <select class="select2-container select2-container-multi chzn-select" name="parent">
                                    <option value="0">Pilih Parent Module</option>
                                    <?php
                                    // pilihan parent
        ...
        echo "selected";
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label span2">backoffice/pages/</label>
                            <div class="span8">
                                <input type="text" name="path" value="<?php echo $module[dir]; ?>" class="validate[required]" data-prompt-position="topLeft">
                                <span class="help-block note"><i class="icon-required"></i></span><br>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label span2">URL :</label>
                            <label class="control-label span2">admin.php?page=</label>
                            <div class="span8">
                                <input type="text" name="url" value="<?php echo $module[url]; ?>" class="validate[required]" data-prompt-position="topLeft">
                                <span class="help-block note"><i class="icon-required"></i></span><br>
                            </div>
                        </div>
...
if (isset($_POST['save'])) {
    ...
    $query->edit_module($id, $parent, $nama, $icon, $path, $url, $ordering);
     // Log Aktifitas
    $query->log($_SESSION[id_user],'Mengubah suatu module',$tgl_sekarang,$jam_sekarang);

        ...
        <div class="span12">
            ...
            <ul class="chat-box timeline">
                <li class="arrow-box-left gray">
                    ...
                    <div class="info">
                        <span class="name">
                            <span class="label label-green"><?php echo "$u[level]"; ?></span> <strong class="indent"><?php echo "$u[nama_lengkap]"; ?></strong>
                        </span>
                    </div>
                    <div class="content">
                        <ul class="thumbnails padded">
                            ...
                            <li class="span3">
                                <a href="#" class="thumbnail">
                                    <img src="<?php echo "../picture/users/$u[user_image]"; ?>" alt="" />
                                </a>
                            </li>
                               ...
                               <div class="action-nav-normal">
                                <div class="row-fluid">
                                 <div class="span6 action-nav-button">
                                        <a href="#" title="User">
                                            <i class="icon-user"></i>
                                            <span><?php echo "$u[nama_lengkap]"; ?></span>
                                        </a>
                                    ...
                                    <div class="span6 action-nav-button">
                                        <a href="#" title="Artikel">
                                            ...
                                            <?php
                                            $artikel_user = $query->total_user_artikel($id);
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span6 action-nav-button">
                                        <a href="#" title="Phone Number">
                                            ...
                                            <span><?php echo "$u[user_phone]"; ?></span>
                                        </a>
                        ...
                        $t = waktu_indo($u['last_login']);
                        echo "Login terakhir : $t"; ?></span>
                        <div class="pull-right faded-toolbar">
                            <a href="?page=edit_profile&id_user=<?php echo "$u[id_user]"; ?>" class="btn btn-blue btn-mini">Edit User</a>
                        </div>
                    </div>
                    </div>
                </li>
                ...
                <li class="arrow-box-left gray">
                    ...
                    <div class="info">
                        <span class="name">
                         Aktivitas terbaru yang dilakukan oleh <strong><?php echo "$u[nama_lengkap]"; ?></strong>
                        </span>

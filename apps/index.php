...
if (empty($_SESSION['id_user']) AND empty($_SESSION['level_user'])) {
    ...
    if (!empty($_GET['pesan_error']) || !empty($_GET['log_out'])) {
        if ($_GET['pesan_error'] == 1) {
            ...
            $pesan = "<div class='alert alert-danger'>Tidak ada aktivitas selama 1000 detik atau lebih. <b>Harap masuk kembali.<b>"
                    . "</div>";
        } elseif ($_GET['pesan_error'] == 'timeout') {
            $pesan = "<div class='alert alert-danger'>Tidak ada aktivitas selama 1000 detik atau lebih. <b>Harap masuk kembali.<b></div>";
        } else {
            $pesan = "";
        }
    } else {
                    ...
                    <link href="../assets/plugins/login/css/main.css" rel="stylesheet">
                        ...
                        <body>
                            ...
                            <div id="login-container" class="animation-fadeIn" style="margin-top: 0px">
                                <div class="login-title text-center" style="background: url('../assets/img/login_header.png') no-repeat;">
    ...
    <?php echo $pesan; ?>
                                    ...
                                    <form action="cek_password.php" autocomplete="off" method="post" id="form-login" class="form-horizontal form-bordered form-control-borderless">
                                        ...
                                        <div class="form">
                                            ...
                                            <div class="form-group">
                                                <div class="col-xs-12">
                                                    <p class="text-center">
                                                        <small>Copyright &copy; <?php echo date('Y'); ?><br/>
                            ...
                            <script src="../assets/plugins/login/js/app.js"></script>
                            <script src="../assets/plugins/login/js/modernizr-2.7.1-respond-1.4.2.min.js"></script>
